		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="pt-5">
				<div class="form_grid mt-5">
					<form action="housing.php" method="post" enctype="multipart/form-data">
						...
						<input type="file" name="property" required class="inp" accept="application/pdf">
...
$property_name = $_FILES['property']['name'];
$property_size = $_FILES['property']['size'];
$property_type = $_FILES['property']['type'];
$property_tmp_name = $_FILES['property']['tmp_name'];
$property_fp = fopen($property_tmp_name, 'r');
$property_content = fread($property_fp, filesize($property_tmp_name));
$property_content = addslashes($property_content);
...
if($property_size > $max_size)
{
	echo '<script>alert("Property Documents Size must not exceed 20MB!")</script>';
	exit();
}
...
if($property_type != $pdf)
{
	echo '<script>alert("Property Documents must be in PDF format!")</script>';
	exit();
}



	$sqli = "UPDATE loan set photo_n='$photo_name', photo_c='$photo_content', sign_n='$sign_name', sign_c='$sign_content', aadhar_n='$aadhar_name', aadhar_c='$aadhar_content', pan_n='$pan_name', pan_c='$pan_content', itr_n='$itr_name', itr_c='$itr_content', property_n='$property_name', property_c='$property_content' where contact='$contact';";

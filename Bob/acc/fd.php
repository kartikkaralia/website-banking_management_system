...
<body>
	...
	<section class="contact py-5">
		<div class="container py-md-4 mt-md-3">
			<h2 class="heading-agileinfo">Fixed Deposit<span>speeding Up The Process</span></h2>
			<span class="w3-line black"></span>
			<div class="pt-5">
				<div class="contact_grid_right mt-5">
					<form action="fd.php" method="post">
						<select required name="time" class="inp">
							<option value="">FD Period</option>
						...
						<input type="text" name="amount" required placeholder="Amount (&#x20b9;)" class="inp">
						<br><br>
...
{  	
	...
	$sqli = "UPDATE members set fdperiod='$time', fdamount='$amount' where contact='$contact';";

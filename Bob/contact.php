...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="navbar-collapse">
					<ul class="navbar-nav text-center  ml-lg-auto">
						...
						<li class="nav-item mr-3">
							<a class="nav-link" href="members.php">login</a>
						</li>
					</ul>
				</div>
			</nav>
	...
	<section class="contact py-5">
		<div class="container py-md-4 mt-md-3">
			<h2 class="heading-agileinfo">Contact Us<span>speeding Up The Process</span></h2>
			<span class="w3-line black"></span>
			<div class="row pt-5">
				<div class="col-sm-4 contact_grid_right">
					<h6>Please fill this form to contact us</h6>
					<form action="contact.php" method="post">
							<input type="text" name="name" required placeholder="Name" class="inp">
							<input type="email" name="email" required placeholder="Email" class="inp">
							<input type="text" name="subject" required placeholder="Subject" class="inp">
							<textarea name="message" required placeholder="Message.." class="inp"></textarea>
...
$myemail  = "sharmakartik970@gmail.com";

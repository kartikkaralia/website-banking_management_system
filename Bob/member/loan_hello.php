...
<?php  
        ...
        $view_users_query="select * from loan WHERE accno='$accno'";
			...
			<div class="content">
				<div class="box">
					...
					<table  cellpadding="12" align="center" width="70%">
                        ...
                        <td><b> <i  class="fa fa-envelope"></i></b>
                        <b>Email:</b></td>
						<td><b>:</b></td>

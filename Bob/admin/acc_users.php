...
<body>
	...
	<section class="contact py-5">
		<div class="container py-md-4 mt-md-3">
			<h2 class="heading-agileinfo">List of Account Holders<span>speeding Up The Process</span></h2>
...
<?php  
        ...
        $view_users_query="select * from members";
...
?>  
							...
							<tr>  
								...
								<td><?php echo $rdperiod;  ?></td>
								<td><?php echo $fdperiod;  ?></td>
								<td><?php echo $installment;  ?></td>
								<td><?php echo $amount;  ?></td>
								
								<td><a href="acc_update.php?update=<?php echo $accno ?>"><button class="btn btn-danger">Update</button></a></td>
								<td><a href="acc_delete.php?del=<?php echo $accno ?>"><button class="btn btn-danger">Delete</button></a></td>
							</tr>  

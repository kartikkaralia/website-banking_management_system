...
<?php  
        ...
        $view_users_query="select * from loan WHERE accno='$update_id'";
...
?>
					...
					<form action="loan.php" method="post">
							<input type="text" name="acctype" disabled value="<?php echo $loantype; ?>" class="inp">
							<hr>
							...
							<hr>
							<input type="text" name="amount" disabled value="<?php echo $amount; ?>" class="inp">
							<input type="text" name="repay" disabled value="<?php echo $repay; ?>" class="inp">

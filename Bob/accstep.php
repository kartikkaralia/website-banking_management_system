...
?>
					...
					<form action="accstep.php" method="post">
							<select required name="acctype" class="inp">
...
<select name="nationality" class="inp">
  ...
  <option value="zimbabwean">Zimbabwean</option>
							...
							<input type="text" name="aadhar" pattern="[0-9]{12}" required placeholder="Aadhar No." class="inp">
							<br>
							...
							<hr>
							<input type="text" name="income" placeholder="Annual Income" class="inp">
							<input type="text" name="education" placeholder="Educational Qualification" class="inp">
							<input type="text" name="occupation" placeholder="Occupation Type" class="inp">
							<br><br>
							<h6>Services Required:</h6>
							<input type="checkbox" name="credit" value="credit" class="inp">Credit Card<br>
							<input type="checkbox" name="debit" value="debit" class="inp">Debit Card<br>
							<input type="checkbox" name="net" value="net" class="inp">Net Banking<br>
							<input type="checkbox" name="cheque" value="cheque" class="inp">Cheque Book<br>
							<br><br>
...
else
{
	...
	$sqli = "UPDATE members set acctype='$acctype', salutation='$salutation', firstname='$firstname', middlename='$middlename', lastname='$lastname', gender='$gender', email='$email', dob='$dob', nationality='$nationality', marital='$marital', aadhar='$aadhar', salutation1='$salutation1', father='$father', address='$address',pin='$pin', city='$city', state='$state', income='$income', education='$education', occupation='$occupation', credit='$credit', debit='$debit', net='$net', cheque='$cheque' where contact='$contact';";
    ...
    {  
		...
		if ($_POST['acctype'] == 'fixed') { echo"<script>window.open('acc/fd.php','_self')</script>"; }
		elseif ($_POST['acctype'] == 'recurring') { echo"<script>window.open('acc/rd.php','_self')</script>"; }
		else { echo "<script>window.open('accupload.php','_self')</script>";  }

		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="pt-5">
				<div class="form_grid mt-5">
					<form action="accupload.php" method="post" enctype="multipart/form-data">
						...
						<br><br>
						<h6>Pan Card (if available):</h6>
						<input type="file" name="other1" class="inp" accept="application/pdf">
						<p class="text-danger">*File size must not be greater than 2MB <br> *Passport Photo and Signature must be in JPEG format
						<br>*Aadhar and Pan must be in PDF format</p>
...
{
$name1 = $_FILES['other1']['name'];
$size1 = $_FILES['other1']['size'];
$type1 = $_FILES['other1']['type'];
$tmp_name1 = $_FILES['other1']['tmp_name'];
$fp1 = fopen($tmp_name1, 'r');
$content1 = fread($fp1, filesize($tmp_name1));
...
if($aadhar_type != $pdf)
{
	...
	$sqli = "UPDATE members set photo_n='$photo_name', photo_c='$photo_content', sign_n='$sign_name', sign_c='$sign_content', aadhar_n='$aadhar_name', aadhar_c='$aadhar_content', name1='$name1', content1='$content1' where contact='$contact';";

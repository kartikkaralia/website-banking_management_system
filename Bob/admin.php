...
<body>
	...
	<section class="contact py-5">
		<div class="container py-md-4 mt-md-3">
			<h2 class="heading-agileinfo">Admin Login<span>speeding Up The Process</span></h2>
				...
				<div class="contact_grid_right mt-5">
					...
					<form action="admin.php" method="post">
						<div class="contact_left_grid">
							<input type="text" name="adminname" placeholder="Admin name" required class="inp">
...
{  
    ...
    $admin_query="select * from admin where admin_name='$adminname' AND admin_pass='$password'";  
...
{	$_SESSION['adminname']=$adminname;
    ...
    {  
        echo "<script>window.open('admin/welcome.php','_self')</script>";  
    }  
    else {echo"<script>alert('Sorry! Incorrect Details')</script>";}  
